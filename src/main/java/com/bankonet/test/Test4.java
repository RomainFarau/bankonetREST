...
import com.bankonet.model.Participation;
...
public class Test4 {
	 public static void main(String[] args) {
		    ...
		    try {
		      emf = Persistence.createEntityManagerFactory("Employe");
		      ...
		      //Ajout projet
		      emp1.ajouterProjet(projet1);
		      emp1.ajouterProjet(projet2);
		      
		      emp2.ajouterProjet(projet1);
		      emp2.ajouterProjet(projet3);
		      
		      emp3.ajouterProjet(projet2);
		      
		     emp1.ajouterParticipant(projet1, "chef");
